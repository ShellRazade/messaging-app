...
const Chats = () => {
  ...
  return (
    <div className=''>
      ...
      <div className="pl-16 md:pl-16 pt-10 md:pt-8">
        <div className="border shadow-sm rounded-lg bg-white ml-4 h-auto md:h-24 w-full md:w-11/12 mb-6 md:mb-10 md:mt-3 p-3">
          <p className="text-center pt-2 text-xl text-[#9078de] font-semibold md:text-3xl">
            Welcome to Chat-App!
          </p>
        </div>
